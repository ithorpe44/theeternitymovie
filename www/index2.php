...
?>
				...
				<div id="feature">
					...
					<div id="popup">
							...
							<p>
								<script type="text/javascript" src="http://x.cashmusic.org/public/cashmusic.js"></script>
								<script type="text/javascript"> window.cashmusic.embed('http://x.cashmusic.org/public/','4202');</script>
							</p>
						</div>
				</div>
